...
$sql = "SELECT image FROM pictures where division_id=3 ";
        ...
        <div class="row" >
            <div class="col-lg-6 col-md-6">
                ...
                <video width="640" height="480" controls autoplay>
                    <source src="chittagong_land.mp4" muted autoplay loop class="video" >
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                    ...
                    <div class="card-body"  >
                        <h2 class="card-title" >Sajek Valley/সাজেক ভ্যালি</h2>
                        <br>
